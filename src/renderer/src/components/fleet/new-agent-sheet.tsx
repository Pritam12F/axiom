...
import { Field, FieldGroup, FieldLabel, FieldDescription } from '@renderer/components/ui/field'
...
import type { MachineSize } from '@renderer/lib/types'
import { formatCurrency } from '@renderer/lib/format'

const SIZE_SPECS: Record<
  MachineSize,
  { label: string; vcpu: number; memoryGb: number; costPerHour: number }
> = {
